...
knitr::include_graphics("images/Prediction_Rsq.png")
```
...
3) Undertake the Data Analysis for the Supermarket Data Set to investigate the relationships between the response variable and a set of explanatory variables, which you think are worthy of attention. Present your points of view about the nature of the relationships and give a complete explanation, within the data analysis methodology, of this analysis.
